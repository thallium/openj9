...
public:
    ...
    TR_RelocationErrorCode applyRelocations(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *reloOrigin);

private:
    TR_RelocationErrorCode checkInliningTable(TR_RelocationRuntime *reloRuntime);

    TR_RelocationErrorCode handleRelocation(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
...
public:
    ...
    virtual TR_RelocationErrorCode applyRelocationAtAllOffsets(TR_RelocationRuntime *reloRuntime,
        TR_RelocationTarget *reloTarget, uint8_t *relocationOrigin);
...
protected:
    ...
    uint8_t *computeHelperAddress(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
...
public:
    ...
    TR_RelocationRecordRecompQueuedFlag(TR_RelocationRuntime *reloRuntime, TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordWithInlinedSiteIndex(TR_RelocationRuntime *reloRuntime,
...
protected:
    uintptr_t currentConstantPool(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uintptr_t oldValue);
    uintptr_t findConstantPool(TR_RelocationTarget *reloTarget, uintptr_t oldValue, TR_OpaqueMethodBlock *ramMethod);
    uintptr_t computeNewConstantPool(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uintptr_t oldValue);
};
...
public:
    ...
    TR_RelocationRecordConstantPoolWithIndex(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
    ...
    TR_OpaqueMethodBlock *getInterfaceMethodFromCP(TR_RelocationRuntime *reloRuntime, void *void_cp, int32_t cpIndex,
        TR_OpaqueMethodBlock *callerMethod);
    TR_OpaqueMethodBlock *getAbstractMethodFromCP(TR_RelocationRuntime *reloRuntime, void *void_cp, int32_t cpIndex,
        TR_OpaqueMethodBlock *callerMethod);
};
...
public:
    ...
    TR_RelocationRecordAbsoluteHelperAddress(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_OpaqueClassBlock *computeNewClassAddress(TR_RelocationRuntime *reloRuntime, uintptr_t newConstantPool,
        uintptr_t inlinedSiteIndex, uintptr_t cpIndex);
...
public:
    ...
    TR_RelocationRecordDirectJNISpecialMethodCall(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_RelocationRecordDirectJNIVirtualMethodCall(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordDirectJNICall(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordDirectJNIStaticMethodCall(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordDirectJNICall(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordStaticRamMethodConst(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_RelocationRecordVirtualRamMethodConst(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordRamMethodConst(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordSpecialRamMethodConst(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordRamMethodConst(reloRuntime, record)
    {}
...
protected:
    TR_RelocationErrorCode relocateAndRegisterThunk(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uintptr_t cp, uintptr_t cpIndex, uint8_t *reloLocation);
...
public:
    ...
    TR_RelocationRecordJ2IVirtualThunkPointer(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
protected:
    virtual void preparePrivateData(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget);
    virtual bool verifyClass(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
...
public:
    ...
    TR_RelocationRecordVerifyRefArrayForAlloc(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_RelocationRecordVerifyClassObjectForAlloc(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedAllocation(reloRuntime, record)
    {}
...
protected:
    virtual void fixInlinedSiteInfo(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        TR_OpaqueMethodBlock *inlinedMethod);

    virtual bool needsReceiverClassFromID() { return false; }

    bool inlinedSiteCanBeActivated(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        J9Method *currentMethod);

private:
    virtual bool inlinedSiteValid(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        TR_OpaqueMethodBlock **theMethod);
    ...
    virtual void invalidateGuard(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *reloLocation)
    {}

    virtual void activateGuard(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *reloLocation)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedStaticMethodWithNopGuard(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_RelocationRecordInlinedStaticMethod(TR_RelocationRuntime *reloRuntime, TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedSpecialMethodWithNopGuard(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordNopGuard(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedSpecialMethod(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedVirtualMethodWithNopGuard(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordNopGuard(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedVirtualMethod(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedInterfaceMethodWithNopGuard(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordNopGuard(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedInterfaceMethod(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedAbstractMethodWithNopGuard(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordNopGuard(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordInlinedAbstractMethod(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordProfiledInlinedMethod(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordInlinedMethod(reloRuntime, record)
    {}
    ...
    void setClassChainIdentifyingLoaderOffsetInSharedCache(TR_RelocationTarget *reloTarget,
        uintptr_t classChainOffsetInSharedCache, TR::AheadOfTimeCompile *aotCompile,
        const AOTCacheClassChainRecord *classChainRecord);
    ...
    TR_OpaqueMethodBlock *getInlinedMethod(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
...
public:
    ...
    void setClassChainOffsetInSharedCache(TR_RelocationTarget *reloTarget, const TR::AOTClassInfo *aotCI,
...
protected:
    virtual TR_OpaqueClassBlock *getClassFromCP(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        void *void_cp);
    virtual bool validateClass(TR_RelocationRuntime *reloRuntime, TR_OpaqueClassBlock *clazz,
...
public:
    ...
    TR_RelocationRecordValidateInstanceField(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
protected:
    virtual TR_OpaqueClassBlock *getClass(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        void *void_cp);
    virtual bool validateClass(TR_RelocationRuntime *reloRuntime, TR_OpaqueClassBlock *clazz,
        void *classChainOrRomClass);
};
...
public:
    ...
    TR_RelocationRecordValidateArbitraryClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    ...
    void setClassChainOffsetForClassBeingValidated(TR_RelocationTarget *reloTarget, const TR::AOTClassInfo *aotCI,
        TR::AheadOfTimeCompile *aotCompile);
...
public:
    ...
    void setClassChainOffset(TR_RelocationTarget *reloTarget,
...
public:
    ...
    TR_RelocationRecordValidateProfiledClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    ...
    void setClassChainOffset(TR_RelocationTarget *reloTarget, const TR::ProfiledClassRecord *validationRecord,
        TR::AheadOfTimeCompile *aotCompile);
    uintptr_t classChainOffset(TR_RelocationTarget *reloTarget);
...
public:
    ...
    TR_RelocationRecordValidateDefiningClassFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateStaticClassFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordValidateClassFromCP(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateArrayClassFromComponentClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateSuperClassFromClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateClassInstanceOfClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateSystemClassByName(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateClassFromITableIndexCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordValidateClassFromCP(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateDeclaringClassFromFieldOrStatic(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordValidateClassFromCP(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateConcreteSubClassFromClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    void setClassChainOffset(TR_RelocationTarget *reloTarget, const TR::ClassChainRecord *validationRecord,
        TR::AheadOfTimeCompile *aotCompile);
    uintptr_t classChainOffset(TR_RelocationTarget *reloTarget);
};
...
public:
    ...
    TR_RelocationRecordValidateMethodFromClass(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateMethodFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateStaticMethodFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_RelocationRecordValidateSpecialMethodFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordValidateMethodFromCP(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateVirtualMethodFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordValidateMethodFromCP(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateVirtualMethodFromOffset(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
    ...
    void setVirtualCallOffsetAndIgnoreRtResolve(TR_RelocationTarget *reloTarget,
        uint16_t virtualCallOffsetAndIgnoreRtResolve);
...
public:
    ...
    TR_RelocationRecordValidateInterfaceMethodFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateImproperInterfaceMethodFromCP(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordValidateMethodFromCP(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateMethodFromClassAndSig(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateDynamicMethodFromCallsiteIndex(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateHandleMethodFromCPIndex(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateStackWalkerMaySkipFrames(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateClassInfoIsInitialized(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateMethodFromSingleImpl(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateMethodFromSingleInterfaceImpl(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateMethodFromSingleAbstractImpl(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    virtual TR_RelocationErrorCode applyRelocation(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *reloLocation);
    virtual void storePointer(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *reloLocation);
    virtual void activatePointer(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *reloLocation);
...
public:
    ...
    TR_RelocationRecordDiscontiguousSymbolFromManager(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordSymbolFromManager(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordResolvedTrampolines(TR_RelocationRuntime *reloRuntime, TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordArbitraryClassAddress(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
...
public:
    ...
    TR_RelocationRecordInlinedMethodPointer(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecordWithInlinedSiteIndex(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordClassUnloadAssumption(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
private:
    uint8_t *computeTargetMethodAddress(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget,
        uint8_t *baseLocation);
};
...
public:
    ...
    TR_RelocationRecordValidateJ2IThunkFromMethod(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordValidateIsClassVisible(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordCatchBlockCounter(TR_RelocationRuntime *reloRuntime, TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordMethodEnterExitHookAddress(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordCallsiteTableEntryAddress(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
...
public:
    ...
    TR_RelocationRecordMethodTypeTableEntryAddress(TR_RelocationRuntime *reloRuntime,
        TR_RelocationRecordBinaryTemplate *record)
        : TR_RelocationRecord(reloRuntime, record)
    {}
