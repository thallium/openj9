...
private:
	...
	MM_OwnableSynchronizerObjectList *_nextList; /**< -UNUSED- a pointer to the next OwnableSynchronizer list in the global linked list of lists */
	J9JavaVM 			*_javaVM;
...
public:
	 ...
	 */
	uintptr_t heapWalkCallback(J9JavaVM *javaVM, J9MM_IterateObjectDescriptor *objectDesc, J9MM_IterateRegionDescriptor *regionDesc);
